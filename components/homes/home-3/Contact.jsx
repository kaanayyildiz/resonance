      ...
      <div className="col-lg-5 d-flex align-items-stretch mb-md-50">
        <div className="contact-1-left light-content">
          <div className="p-4 p-md-5">
            ...
            <div className="contact-1-text">+90 212 786 61 09</div>
            <div className="contact-1-link">
              {/* Change the phone number in the "href" attribute */}
              <a href="tel:+902127866109">Call now</a>
            </div>
          </div>
          <hr className="contact-1-line mt-0 mb-0" />
          <div className="p-4 p-md-5">
            <h3 className="contact-1-title">Address</h3>
            <div className="contact-1-text mb-10">İstanbul Trakya Serbest Bölgesi, Ferhatpaşa SB Mah Ali Rıza Efendi Cad. Kat:2BK, DKN: 17, İKN: 2B1 Çatalca / İstanbul 34540</div>
            <div className="contact-1-link">
              <a href="#">See map</a>
            </div>
          </div>
          ...
          <div className="p-4 p-md-5">
            ...
            info@metalyapi-inox.com
            </div>
            <div className="contact-1-link">
              {/* Change the email address in the "href" attribute */}
              <a href="mailto:info@metalyapi-inox.com">Say hello</a>
            </div>
          </div>
        </div>
      </div>
